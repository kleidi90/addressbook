...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AddressBookType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AddressBookType']) ? $this->services['AppBundle\Form\AddressBookType'] : $this->services['AppBundle\Form\AddressBookType'] = new \AppBundle\Form\AddressBookType()) && false ?: '_'};
