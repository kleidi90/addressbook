...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            'appbundle\\controller\\addressbookcontroller' => 'AppBundle\\Controller\\AddressBookController',
            'appbundle\\controller\\defaultcontroller' => 'AppBundle\\Controller\\DefaultController',
            'appbundle\\form\\addressbooktype' => 'AppBundle\\Form\\AddressBookType',
            'appbundle\\services\\filemanager' => 'AppBundle\\Services\\FileManager',
        ...
        $this->fileMap = array(
            'AppBundle\\Controller\\AddressBookController' => 'getAddressBookControllerService.php',
            'AppBundle\\Controller\\DefaultController' => 'getDefaultControllerService.php',
            'AppBundle\\Form\\AddressBookType' => 'getAddressBookTypeService.php',
            'AppBundle\\Services\\FileManager' => 'getFileManagerService.php',
            ...
            'service_locator.d6sovxk' => 'getServiceLocator_D6sovxkService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\AddressBookType' => true,
            'AppBundle\\Services\\FileManager' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4-gFa5jWUU', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Lyfp0zNDxB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YNxuwu6gUL', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9l9DYel9Yf', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uqKpsB-y6w', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2d3c78f5cafe3c0ec5fa8dce17081d69b40891bc')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2d3c78f5cafe3c0ec5fa8dce17081d69b40891bc');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'pictures_directory': $value = ($this->targetDirs[3].'/web/uploads/'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '2d3c78f5cafe3c0ec5fa8dce17081d69b40891bc',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => '2d3c78f5cafe3c0ec5fa8dce17081d69b40891bc',
